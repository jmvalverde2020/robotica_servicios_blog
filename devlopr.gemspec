...
Gem::Specification.new do |spec|
  spec.name          = "robotica_servicios_blog"
  spec.version       = "0.4.9"
  spec.authors       = ["Juanmi Valverde"]
  spec.email         = ["jm.valverde.2020@alumnos.urjc.es"]

  spec.summary       = %q{ A Jekyll Theme built for developers }
  spec.homepage      = "https://github.com/jmvalverde2020/robotica_servicios_blog"
  spec.license       = "MIT"
